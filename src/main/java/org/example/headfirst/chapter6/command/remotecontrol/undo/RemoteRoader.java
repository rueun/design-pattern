package org.example.headfirst.chapter6.command.remotecontrol.undo;


import org.example.headfirst.chapter6.command.remotecontrol.undo.command.*;
...
public class RemoteRoader {
    public static void main(String[] args) {
        ...
        final CeilingFanHighCommand ceilingFanOn = new CeilingFanHighCommand(ceilingFan);
